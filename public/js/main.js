...
class Main{
    constructor(index){
        ...
        this.myCanvasWrapper.innerHTML = `<h1 style="text-align: center;padding-top:200px">Please add file first</h1><br>
                                        <h1 style="text-align: center;padding-top:20px">Please add layer then</h1>
                                        `;
