...
// implement the addition of image
    this.canvas.addEventListener("touchstart", (event)=>{
    ...
    if(this.is_crop_clicked && !this.is_Image__add__Clicked){
        ...
        this.getBase64(uplCropedImage).then(
            data => {
                ...
                imgObj.onload = () => {
                    this.context.drawImage(imgObj, currentMousePosition.x,
                        currentMousePosition.y, this.swidth, this.sheight, currentMousePosition.x + 50, currentMousePosition.y + 50,  this.dwidth, this.dheight)
                        console.log("croped")
